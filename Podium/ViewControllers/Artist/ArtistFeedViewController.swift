...
class ArtistFeedViewController: UIViewController, UICollectionViewDataSource, UICollectionViewDelegate {
    ...
    func getPosts() {
        ...
        ref.child("artists").queryOrderedByKey().observeSingleEvent(of: .value) { (snapshot) in
