//
//  ArtistSignUpViewController.swift
//  Podium
//
...
class ArtistSignUpViewController: UIViewController, UIImagePickerControllerDelegate, UINavigationControllerDelegate, UITextFieldDelegate {
    ...
    var artistStorage : StorageReference!
    ...
    override func viewDidLoad() {
        ...
        artistStorage = storage.child("artists")
            ...
            if passwordText.text == passwordConfirm.text {
                Auth.auth().createUser(withEmail: emailText.text!, password: passwordText.text!, completion: { (user, error) in
                    ...
                    if let user = user {
                        ...
                        let imageRef = self.artistStorage.child("\(user.uid).jpg")
                        ...
                        let uploadTask = imageRef.putData(data!, metadata: nil, completion: { (metadata, err) in
                            ...
                            imageRef.downloadURL(completion: { (url, er) in
                                ...
                                if let url = url {
                                    ...
                                    self.ref.child("artists").child(user.uid).setValue(userInfo)
